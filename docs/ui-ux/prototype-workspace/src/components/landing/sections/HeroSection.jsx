        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              ...
              <span className="text-primary-600">{t('hero.heading.rbac')}</span> {t('hero.heading.and')}{' '}
              <span className="text-primary-600">{t('hero.heading.subscriptions')}</span>
            </h1>
          ...
          <div className="relative">
            <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-200">
              <div className="aspect-video bg-gradient-to-br from-primary-100 to-primary-200 rounded-lg flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 font-medium">{t('hero.illustration.text')}</p>
                </div>
              </div>
            </div>
            ...
            <div className="hidden lg:block absolute -top-6 -right-6 bg-white rounded-xl shadow-lg p-4 border border-gray-200">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-gray-900">99.9% {t('hero.badges.uptime')}</span>
              </div>
            </div>
            ...
            <div className="hidden lg:block absolute -bottom-6 -left-6 bg-white rounded-xl shadow-lg p-4 border border-gray-200">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-600">{t('hero.badges.activeClients')}<br/>{t('hero.badges.activeClientsLine2')}</span>
              </div>
            </div>
          </div>
        </div>
