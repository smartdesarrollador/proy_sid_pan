    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">
          ...
          {!canManageBilling() && <span className="ml-2 text-sm text-blue-600 font-medium">(Solo lectura)</span>}
        </p>
      </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-bold text-gray-900">Comparar Planes</h3>
          <div className="flex items-center gap-2 p-1 bg-gray-100 rounded-lg">
            ...
            >
              Anual
              <span className="ml-2 text-xs badge bg-green-100 text-green-800">-10%</span>
            </button>
          </div>
        </div>
