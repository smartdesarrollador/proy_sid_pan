      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            ...
            {isReadOnly && <span className="ml-2 text-sm text-blue-600 font-medium">(Solo lectura)</span>}
          </p>
        </div>
        {canCreateRoles() ? (
          <button
              ...
              {role.parentRole && (
                <div className="mb-4 p-3 bg-gray-50 rounded-lg">
                  <p className="text-xs text-gray-600">
                    Hereda permisos de: <span className="font-medium text-gray-900">{role.parentRole}</span>
                  </p>
                </div>
              )}
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                  <p className="text-2xl font-bold text-gray-900">{selectedRole.usersCount}</p>
                  <p className="text-xs text-gray-600 mt-1">Usuarios</p>
                </div>
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                  <p className="text-2xl font-bold text-gray-900">{selectedRole.permissionsCount}</p>
                  <p className="text-xs text-gray-600 mt-1">Permisos</p>
                </div>
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                  <p className="text-xs text-gray-600">Creado</p>
                  <p className="text-sm font-medium text-gray-900 mt-1">{selectedRole.createdAt}</p>
                </div>
              </div>

              {/* Permissions List */}
              <div>
                <h3 className="text-sm font-semibold text-gray-900 mb-3">Permisos Asignados</h3>
