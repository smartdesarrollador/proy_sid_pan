  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Auditoría y Compliance</h1>
      ...
      <div className="card">
        <div className="p-6 border-b border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900">Cronología de Eventos</h3>
        </div>
                  ...
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      ...
                      <p className="text-sm text-gray-900 font-medium">
                        <span className="text-primary-600">{log.actor}</span> {log.details.toLowerCase()}
                      </p>
                  ...
                  <details className="mt-3">
                    ...
                    <div className="mt-3 p-4 bg-gray-50 rounded-lg space-y-2">
                      <div className="grid grid-cols-2 gap-3 text-xs">
                        <div>
                          <p className="text-gray-600 font-medium mb-1">ID del Evento</p>
                          <p className="text-gray-900 font-mono">{log.id}</p>
                        </div>
                        <div>
                          <p className="text-gray-600 font-medium mb-1">Dirección IP</p>
                          <p className="text-gray-900 font-mono">{log.ipAddress}</p>
                        </div>
                        <div className="col-span-2">
                          <p className="text-gray-600 font-medium mb-1">User Agent</p>
        ...
        <div className="card p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600">Eventos exitosos</p>
            </div>
          </div>
        </div>
        ...
        <div className="card p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600">Eventos fallidos</p>
            </div>
          </div>
        </div>
